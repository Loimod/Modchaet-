...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>modchaet  chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "modchaet ", HidePremium = false, IntroText = "modchaet ⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("modchaet  SCRIPT")
W:AddLabel("Discordmodchaet ")
local Section = W:AddSection({
    Name = "Status"
})
